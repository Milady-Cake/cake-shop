...
const updateCake = async (req, res) => {
  try {
      const { id, name, description, category, rating, weights, prices } = req.body;
      ...
      await cakeModel.findByIdAndUpdate(id, { name, description, category, rating, weights: parsedWeights, prices: parsedPrices, images });
