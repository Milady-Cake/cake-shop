...
//         <SwiperSlide
//         key={item._id}
//         className="flex lg:flex-row sm:flex-col bg-slate-400 items-center gap-5 border rounded-lg w-full p-4 max-md:gap-3 max-sm:p-3"
//       >
//         {/* Image on the Left */}
//         <div className="relative group bg-orange-300 w-28 h-28 max-sm:w-24 max-sm:h-24 flex-shrink-0">
//           <img
...
import { Swiper, SwiperSlide } from "swiper/react";
import { StoreContext } from "../../context/StoreContext";
import "./RecommendedProducts.css"; // Importing CSS
...
const RecommendedProducts = () => {
  ...
  return (
    <div className="recommended-container">
      ...
      >
        {cake_list.map((item) => (
          <SwiperSlide key={item._id} className="recommended-slide">
            {/* Left Side - Image */}
            ...
            <div className="content-container">
              ...
              <div className="action-container">
                ...
                <button className="add-to-cart" onClick={() => handleAddToCart(item._id)}>
                  ADD TO CART
                </button>
              </div>
            </div>
